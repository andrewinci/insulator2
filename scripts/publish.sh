...
update_json manifests/update-windows.json '.platforms."windows-x86_64".url' "https://github.com/andrewinci/insulator2/releases/download/v${VERSION}/Insulator 2_${VERSION}_x64_en-US.msi.zip"

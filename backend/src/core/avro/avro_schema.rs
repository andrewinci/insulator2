...
impl AvroSchema {
    pub fn fqn(&self) -> String {
        ...
        match self {
            ...
            AvroSchema::BigDecimal => "big-decimal".into(),
            ...
            AvroSchema::TimestampNanos => "timestamp-nanos".into(),
            AvroSchema::LocalTimestampMillis => "local-timestamp-millis".into(),
            AvroSchema::LocalTimestampMicros => "local-timestamp-micros".into(),
            AvroSchema::LocalTimestampNanos => "local-timestamp-nanos".into(),
    ...
    pub fn from(id: i32, schema: &Schema) -> Self {
        ...
        fn map(s: &Schema, parent_ns: &Option<String>, references: &HashMap<Name, &Schema>) -> AvroSchema {
            match s {
                ...
                Schema::BigDecimal => AvroSchema::BigDecimal,
                ...
                Schema::TimestampNanos => AvroSchema::TimestampNanos,
                Schema::LocalTimestampMillis => AvroSchema::LocalTimestampMillis,
                Schema::LocalTimestampMicros => AvroSchema::LocalTimestampMicros,
                Schema::LocalTimestampNanos => AvroSchema::LocalTimestampNanos,
                Schema::Duration => AvroSchema::Duration,
                Schema::Array(s) => AvroSchema::Array(Box::new(map(&s.items, parent_ns, references))),
                Schema::Map(s) => AvroSchema::Map(Box::new(map(&s.types, parent_ns, references))),
                Schema::Union(s) => {

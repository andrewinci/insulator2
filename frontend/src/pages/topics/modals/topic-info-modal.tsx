...
import { useGetTopicInfo } from "../../../tauri/admin";

export const TopicInfoModal = ({ clusterId, topicName }: { clusterId: string; topicName: string }) => {
  const { data: topicInfo } = useGetTopicInfo(clusterId, topicName);
